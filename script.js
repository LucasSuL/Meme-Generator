 ...
 */
function clearAll(className, element) {
  const elementsToRemove = element.getElementsByClassName(className);
  while (elementsToRemove.length > 0) {
    element.removeChild(elementsToRemove[0]);
  }
}
...
function showMeme() {
  ...
  clearAll('new-generated',contentElement);

  const randomMemeUrl = getRandomData("memes");
  const img = document.createElement('img');
  img.src = randomMemeUrl;
  img.className = 'new-generated';

  const h3Element = document.querySelectorAll('h3').item(1);
  contentElement.insertBefore(img, h3Element);
}
...
function showJoke() {
  ...
  jokeElement.className = 'new-generated';

  const h3Element = document.querySelectorAll('h3').item(2);
  contentElement.insertBefore(jokeElement, h3Element);
}
...
function showQuote() {
  ...
  quoteEle.appendChild(lineBreak);
  const signEle = document.createElement('p');
  signEle.textContent = '- '+randomQuote.author;
  quoteEle.appendChild(signEle);
  quoteEle.className = 'new-generated';

  const h3Element = document.querySelectorAll('h3').item(3);
  contentElement.insertBefore(quoteEle, h3Element);
...
function showRiddle() {
  ...
  riddle.className = 'new-generated';

  const h3Element = document.querySelectorAll('h3').item(3);
  insertAfter(riddle, h3Element);
}
...
function revealAnswers() {
  const contentElement = document.querySelector('.content');
  const checkEle = contentElement.getElementsByClassName('new-generated');
  if(checkEle.length == 0){
    alert('generate riddle first!');
  }else if(checkEle.length == 2){
    alert('answer is already revealed!');
  }else{
    const randomRiddle = getRandomData("riddles");
    const answer = document.createElement('p');
    answer.textContent = '- '+ randomRiddle.answer;
    answer.className = 'new-generated';
 ...
 * Don't worry about how it works, just know how to use it.  
 * Usage is pre-filled in the functions above already, but here's an explanation of the function anyways.
 *
 * Valid arguments:
 *
